 ...
 *
 * The dashboard's Booking Tracker flow. This is where "check if known"
 * lives — an officer scans a face or fingerprint here first, and if a
...
export default function DashboardBookingModal({ onClose, onBooked }) {
